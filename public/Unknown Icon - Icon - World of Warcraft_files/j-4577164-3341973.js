//Generated:2021-02-04 22:34:47// 6-244
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4577164 || '',
    guid: window.ftGUID_4577164 || '',
    confID: window.ftConfID_4577164 || '0',
    ftReturn: window.ftReturn_4577164 || '',
    keyword: window.ftKeyword_4577164 || '',
    ftId: window.ftId_4577164 || '',
    ftImpId: window.ftImp4577164 && window.ftImp4577164.impID || '',
    gdpr: window.ftImp4577164 && window.ftImp4577164.gdpr || '',
    gdpr_consent: window.ftImp4577164 && window.ftImp4577164.gdpr_consent || '',
    gdpr_pd: window.ftImp4577164 && window.ftImp4577164.gdpr_pd || '',
    us_privacy: window.ftImp4577164 && window.ftImp4577164.us_privacy || '',
    campaignID: '125164',
    cID: '122609',
    pID: '4577164',
    creativeID: '3341973',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=125164&sid=18330&plc=4577164&num=&adid=&advid=&adsrv=29&btreg=4577164&btadsrv=flashtalking&crt=3341973&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/8/125164;4577164;3341973;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://adobe.com/go/acrobatwithesignsubscription?sdid=DZTGZZXH&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?199344825-4577164;3341973;',
    centreAd: false,
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/457/4577164/3341973/image/3341973.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/125164;4577164;202;pixel;DV360;DV360FY20SignPSPAudExUSDSKBAN300x600/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/125164;4577164;3341973;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://adobe.com/go/acrobatwithesignsubscription?sdid=DZTGZZXH&mv=display',
    divID: 'ftdiv4577164',
    altimgID: 'ftalt4577164',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4577164 && parseInt(window.ftImp4577164.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4577164') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4577164'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4577164").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4577164").style.display = "none";
		    }
		});
	}
}(ft4577164));
